        ...
        <AuthenticatedLayout header="Barang Masuk">
            ...
            <div style={{ padding: '24px', backgroundColor: '#f8fafc', minHeight: 'calc(100vh - 64px)' }}>
                ...
                <div style={{ 
                    ...
                    <div>
                        <h2 style={{ fontSize: '18px', fontWeight: '700', color: '#1e293b' }}>Riwayat Barang Masuk</h2>
                        <p style={{ margin: 0, fontSize: '14px', color: '#64748b' }}>
                            Total {stockIns.total} transaksi masuk tercatat
                        </p>
                    </div>
                    <Link
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
                        ...
                        <tbody style={{ color: '#1e293b' }}>
                            {stockIns.data.length === 0 ? (
                                ...
                                stockIns.data.map((s, i) => {
                                    return (
                                        <tr key={s.id} style={{ borderBottom: i === stockIns.data.length - 1 ? 'none' : '1px solid #f1f5f9' }}>
                                            ...
                                            <td style={{ padding: '16px 20px', textAlign: 'center', fontWeight: '700', color: '#10b981' }}>
                                                +{s.quantity}
                                            </td>
