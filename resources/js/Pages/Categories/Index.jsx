                ...
                <div style={{ 
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, fontSize: '14px', color: '#64748b' }}>
                            Total {categories.total} kategori terdaftar dalam sistem
                        </p>
                    </div>
                    <Link
                        ...
                        <tbody style={{ color: '#1e293b' }}>
                            {categories.data.length === 0 ? (
                                ...
                                categories.data.map((cat, i) => {
                                    return (
                                        <tr key={cat.id} style={{ borderBottom: i === categories.data.length - 1 ? 'none' : '1px solid #f1f5f9' }}>
                                            <td style={{ padding: '16px 20px', color: '#64748b' }}>{categories.from + i}</td>
                                            <td style={{ padding: '16px 20px', fontWeight: '600' }}>{cat.name}</td>
                                            <td style={{ padding: '16px 20px' }}>{cat.description || '-'}</td>
                                            <td style={{ padding: '16px 20px', textAlign: 'center', fontWeight: '700' }}>{cat.items_count || 0}</td>
