                ...
                <div style={{ width: '100%', maxWidth: '600px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ marginBottom: '32px' }}>
                            <h2 style={{ fontSize: '20px', fontWeight: '800', color: '#1e293b' }}>Informasi Kategori Baru</h2>
                            <p style={{ color: '#64748b', fontSize: '14px', marginTop: '4px' }}>Lengkapi formulir di bawah ini untuk menambahkan kategori baru.</p>
                        </div>
