                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {selectedItem && (
                            <div className={`border rounded-lg px-4 py-3 text-sm ${
                                ...
                                {selectedItem.stock <= selectedItem.min_stock && (
                                    <span className="ml-2">⚠ Stok sudah menipis!</span>
                                )}
                            </div>
                        )}
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <button
                                type="submit"
                                disabled={processing}
                                className="bg-red-600 text-white text-sm px-5 py-2 rounded-lg hover:bg-red-700 transition disabled:opacity-50"
                            >
                                {processing ? 'Menyimpan...' : 'Catat Keluar'}
                            </button>
                            <Link href="/stock-outs" className="text-sm text-gray-500 hover:text-gray-700">
                                Batal
                            </Link>
                        </div>
                    </form>
